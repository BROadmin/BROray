...
`r14c68` является проверенной базовой установкой. После успешной загрузки откройте **BROray → Проверить обновление → Установить обновление**, чтобы перейти на текущий Stable `3.1.0-r09` универсальным обновителем. Этот путь использует общий алгоритм обновления без ручной коррекции файлов, прав и канала.
