...
`r14c68` является проверенной базовой установкой. После успешной загрузки откройте **BROray → Проверить обновление → Установить обновление**, чтобы перейти на текущий Stable `3.0.0-r17` универсальным обновителем. Этот путь повторно прошёл физическую проверку без ручной коррекции файлов, прав и канала.
