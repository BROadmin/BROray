...
`r14c68` является проверенной базовой установкой. После успешной загрузки откройте **BROray → Проверить обновление → Установить обновление**, чтобы перейти на текущий Stable `3.0.1-r02` универсальным обновителем. Этот путь повторно прошёл физическую проверку без ручной коррекции файлов, прав и канала.

После обновления обязательно очистите кэш браузера и заново откройте WebUI. На компьютере используйте `Ctrl+F5`; на мобильном устройстве очистите кэш сайта и перезагрузите страницу.
