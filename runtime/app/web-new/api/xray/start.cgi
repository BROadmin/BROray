...
lock_rc=0
broray_routes_api_lock_acquire 'xray:start' xray || lock_rc=$?
case "$lock_rc" in
    0)
...
output_file="/opt/broray/tmp/broray-xray-start-$$.json"
error_file="/opt/broray/tmp/broray-xray-start-$$.err"
