...
ERROR_FILE="/opt/broray/tmp/broray-routes-status-$$.err"
PRESENCE_FILE="/opt/broray/tmp/broray-routes-presence-$$.json"
PROGRESS_FILE="/opt/broray/tmp/broray-routes-progress-status-$$.json"
GLOBAL_OPERATION_FILE="/opt/broray/tmp/broray-routes-global-operation-$$.json"
...
global_operation_json='{"active":false,"pending":false,"resumable":false,"pid":null,"scope":null,"action":null,"bundleId":null,"startedAt":null,"updatedAt":null,"stale":false}'
