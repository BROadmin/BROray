...
PLAN_FILE="/opt/broray/tmp/broray-routes-operation-preflight-plan-$$.json"
RESULT_FILE="/opt/broray/tmp/broray-routes-operation-preflight-result-$$.json"
ERROR_FILE="/opt/broray/tmp/broray-routes-operation-preflight-$$.err"
