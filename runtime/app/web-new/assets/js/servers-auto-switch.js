(function () {
    ...
    function createSection() {
        ...
        if (!section) {
            ...
            qualitySection = document.querySelector(".server-quality-refresh-section");
            listSection = document.querySelector(".servers-list-section");
            if (qualitySection && qualitySection.parentNode === overview.parentNode) {
                overview.parentNode.insertBefore(section, qualitySection);
            } else if (listSection && listSection.parentNode === overview.parentNode) {
    ...
    function schedulePolling() {
        ...
        pollTimer = window.setTimeout(function () {
            ...
            pollInFlight = true;
            loadStatus(false, false).then(function () {
                pollInFlight = false;
                schedulePolling();
            });
