(function () {
    ...
    function parseStandard(raw) {
        ...
        if (
            ...
            throw new Error(
                "В Shadowsocks отсутствуют данные доступа."
            );
        }
    ...
    function ensureInterface() {
        ...
        if (
            ...
            hint.textContent =
                ...
                "Hysteria2 и Shadowsocks. Несколько конфигураций можно " +
    ...
    function importNext(index) {
        ...
        // API field names are part of the backend contract. Never derive
        // them from presentation-layer DOM attributes such as name=server-uri.
        requestBody[IMPORT_KEY] = item.raw;
