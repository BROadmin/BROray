(function () {
    ...
    var messages = {started:"Операция запущена",lock_acquired:"Ресурсы зарезервированы",lock_conflict:"Действие отложено: выполняется другая операция",phase_changed:"Этап операции изменился",cancel_requested:"Запрошена остановка",completed:"Операция завершена",failed:"Операция завершилась с ошибкой",aborted:"Операция прервана",recovered:"Незавершённая операция восстановлена",ambiguous_owner:"Владелец операции не подтверждён",heartbeat_problem:"Нет свежего сообщения о ходе операции",term:"Управляемому процессу отправлен сигнал завершения",kill:"Управляемый процесс принудительно завершён"};
