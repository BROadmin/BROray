...
broray_server_validate__shadowed_legacy_1_unused() {
    validation_file="$1"
    ...
    jq -e '
        ...
        (((.protocol | type) == "string") and ((.protocol | length) > 0)) and
        (((.address | type) == "string") and ((.address | length) > 0)) and
        (((.port | type) == "number") and (.port >= 1) and (.port <= 65535)) and
        (
            (
                .protocol == "trojan" and
            ...
            (
                .protocol != "trojan" and
                (((.uuid | type) == "string") and ((.uuid | length) > 0))
            )
        ) and
        (((.network | type) == "string") and ((.network | length) > 0)) and
        (((.security | type) == "string") and ((.security | length) > 0)) and
        ((.source | type) == "object") and
        (((.source.type | type) == "string") and ((.source.type | length) > 0))
