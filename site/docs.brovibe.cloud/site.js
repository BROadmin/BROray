...
(function () {
  ...
  document.querySelectorAll('button.copy').forEach(button=>button.addEventListener('click',()=>{
    const scope=button.closest('.light-code-block') || button.parentElement;
