...
Для устройств, где удобнее использовать каталог автозапуска Entware, опубликован отдельный подписанный bootstrap. Это не новый релиз и не другой канал обновлений: он устанавливает точный Stable `3.0.0-r14c68` через штатный механизм `/opt/install/*.tgz`.
