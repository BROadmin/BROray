...
Установщик сам проверяет архитектуру, компоненты, свободное место и контрольные суммы. После успешной установки WebUI обычно доступен по адресу `http://<LAN-IP-роутера>:8080/`.
