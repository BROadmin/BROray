...
BUILDER="/root/BROray-2.2.6-release-candidate-builder-r4.sh"
EXPECTED="6b142780a43fd7649977e729939f5650ac06b343cd1a5f3be610e87fd786b565"
READY=yes

printf '%s\n' "=================================================="
printf '%s\n' "BROray 2.2.6 — запуск проверенного candidate builder r4"
printf '%s\n' "=================================================="
