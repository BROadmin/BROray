...
TEMP="$REPOSITORY_ROOT/scripts/.build-opkg-release-2.1.1-2.$$"
...
replacements={
    ...
    'REVISION="${BRORAY_PACKAGE_REVISION:-2}"': 'REVISION="${BRORAY_PACKAGE_REVISION:-2}"',
    'MANUAL_MIGRATOR_NAME="broray-manual-to-opkg-$PACKAGE_VERSION.sh"': 'MANUAL_MIGRATOR_NAME="broray-manual-to-opkg-2.1.0-2.sh"',
    '"$REPOSITORY_ROOT/scripts/safe-opkg-upgrade.sh"': '"$REPOSITORY_ROOT/scripts/safe-opkg-upgrade-2.1.1-2.sh"',
}
